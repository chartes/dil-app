...
class Person(AbstractVersion):
    ...
    related_patents = relationship("PatentHasRelations", foreign_keys="PatentHasRelations.person_id", overlaps="person")
    linked_patents = relationship("PatentHasRelations", foreign_keys="PatentHasRelations.person_related_id", overlaps="person_related")

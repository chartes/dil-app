"""
Modèle V1.1.0 de la base de données de DIL-App

Commentaires:
 - On part du modèle V1.0
 - On ajoute une table addresse pour les imprimeurs (ajoute de la modularité)
    - attention dans le modèle original les adresses sont stockées a la suite avec une mention de date (champ texte formaté HTML)
    - il n'y a pas de lien direct entre la ville et les adresses
"""

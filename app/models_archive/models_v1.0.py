"""
Modèle V1.0 de la base de données de DIL-App

Commentaires:
 - Copie conforme du modèle original MySQL-Drupal
"""
...
class Printer(Base):
    ...
    professional_adresses = Column(Text, nullable=True, unique=False)
    personal_adresses = Column(Text, nullable=True, unique=False)
